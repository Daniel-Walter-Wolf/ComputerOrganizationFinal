...
def assemble(filename):
    lineCounter = 0
    newdict = {'add':'00000', 'and':'00010', 'or':'00100', 'sub':'00110', 'addi':'00001', 'andi':'00011',
               'ori':'00101', 'subi':'00111', 'beq':'01010', 'jump':'01011', 's0':'000', 's1':'001', 's2':'010', 's3':'011',
               's4':'100',  's5':'101', 's6':'110', 's7':'111', 'lw':'01001', 'sw':'01000'}
    ...
    for line in newfile.readlines():
        if line == '\n':
            ...
            for item in splitLine:
                ...
                elif splitLine[0] == 'jump' and is_number(item):
                    
                    binarystring += int2bs(item,9)
                elif is_number(item):
